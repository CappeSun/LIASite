...
<section class="flex justify-center px-6 mt-6 items-center page-height page-height-desktop">
    <div class="register-container sm:w-2/3 bg-marine1">
        ...
        <form action="/account/create" method="post">
            ...
            <input class="form-input" type="email" id="email" name="email" placeholder="name@example.com" value="{{ old('email') }}" required>
        
            <label class="p1" for="password">Lösenord</label>
            <input class="form-input" type="password" id="password" name="password" placeholder="Lösenord" value="{{ old('password') }}" required>
